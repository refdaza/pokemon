...
// const ordenar = (argument)=> {
//     let validInput = ["type", "base_damage", "base_hp", "speed"]
//     if(validInput.includes(argument)){
//         let result = argument==="type"?
//             (pokemons.sort((a,b)=> a[argument].localeCompare(b[argument]))): (pokemons.sort((a,b)=> a[argument] - b[argument]))
//             console.log(result);
//         }

//     else {
//         console.log("ingresar un argumento valido");
//     }
// }
...
// const filtrarPokemon =(argument)=> {
//     let pokemonFiltrado = pokemons.filter(pokemon=> pokemon.type === argument)
//     let result = pokemonFiltrado.length === 0 ? "tipo de pokemon filtrado": pokemonFiltrado
...
// let pokemonMaster = {
//     id: 1, name: "string", created_date: "string",  pokemon: []
// }

//5. Crear una funcion que de manera aleatoria agregue un nuevo pokemon al atributo pokemon de Pokemon Master.
// const agregar =()=> {

//     pokemonMaster.pokemon=pokemons[Math.floor((Math.random()*pokemons.length))]
...
//         let max_damag = Math.floor(Math.random() * (5-3+1) +3 )
...
//     }else {
//         console.log(`Escribe un numero valido ${pokemons.length - 1}`);
//     }
// }
// pokemonDamage()
...
//   ],
// };
// pokemonMaster.pokemon.sort((a, b)=> b.base_damage - a.base_damage);
